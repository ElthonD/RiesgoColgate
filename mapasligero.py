...
def createPage():
    ...
    def load_HR():
        ...
        rutaA = r'./data/Historico de Robos Colgate.xlsx'
    ...
    try:
        ...
        st.markdown("<h4 style='text-align: left;'>Paso 3: Consultar Histórico de Robos Colgate (Planner) </h4>", unsafe_allow_html=True)
        st.write(""" 
        ...
        df3 = load_HR()
        st.write(f"Este módulo contiene información histórica de los robos de Colgate desde **{df3.Mes.values[0]} {df3.Año.values[0].astype(int)}** a **{df3.Mes.values[-1]} {df3.Año.values[-1].astype(int)}** :")

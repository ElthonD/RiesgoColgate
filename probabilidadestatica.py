...
def createPage():
    ...
    def load_df():
        ...
        rEmbarques = './data/Salidas Colgate.xlsx'
    ...
    def ld_AR():
        rutaAR = './data/Anomalias Robos Colgate.xlsx'
    ...
    @st.cache_resource
    def load_model():
        return pickle.load(open('proba_robo_colgate.pkl', 'rb'))
    
    try:
        
        #Modulo de Predictivo
        st.markdown("<h3 style='text-align: left;'>Paso 1: % Riesgo de los Servicios Colgate</h3>", unsafe_allow_html=True)

        st.write(""" 
        Pasos a seguir para este módulo:
        1. Descargar archivo **"BITÁCORAS"** (Prebitácoras) de **COLGATE IMP-EXP**, **COLGATE NACIONAL** y **COLGATE INTRA** del **Área de Centro de Monitoreo** del **PowerBI**, en el **Reporte CM**, sección **Prebitácoras**.
